...
| **monotonic** | More defect → strictly higher score? (Spearman ρ) | ✅ PASS (ρ ≥ 0.97) |
...
|---|---|---|
| `oiliness` | **0.119** | Worst, and **non-monotonic** — high at I, near-zero II–IV, high again V–VI |
| `darkCircles` | 0.076 | |
| `pores` | 0.072 | |
| `redness` | 0.065 | |
| `texture` / `hydration` | 0.063 | One measurement, counted once |
| `darkSpots` | 0.033 | ✅ passes |
| `fineLines` | 0.021 | ✅ passes |
