// supabase/functions/_shared/checkout/customer-mapping.ts
// Mirrored copy of src/features/checkout/customer-mapping.ts (Deno-importable; Jest imports the
// sibling copy directly since it cannot resolve `.ts`-suffixed relative imports from Deno-style
// edge functions). Keep both copies in sync -- same convention as pricing.ts in this directory.
