...
If you join the early-access list, we collect **your email address**, optionally a phone number,
and your confirmation that you are 18 or older and in the United States. That is everything. We
do not collect your name, your location, or anything about your skin — joining the list involves
no photo and no scan.

**Purpose:** to email you once — and to text you once, if you asked us to — when there is a build
you can use.

**Retention:** we delete what you gave us 90 days after we send you that invite, or 3 years after
you join if we never do, whichever comes first. An automated job enforces this — it is not a
promise we have to remember to keep.

**Unsubscribe:** every email carries a one-tap unsubscribe link, which deletes your record
outright — email address and phone number both — rather than flagging it as inactive.
