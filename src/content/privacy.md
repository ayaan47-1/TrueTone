...
you are 18 or older and in the United States. If you arrive from a referral link we also record
the referral code and a privacy-safe source tag (which page or campaign sent you) — never shared
with any third party. That is everything. We do not collect your name, your location, or anything
about your skin — joining the list involves no photo and no scan.

**Purpose:** to email you once when there is a build you can use.
